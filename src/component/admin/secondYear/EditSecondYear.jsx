  ...
  export const EditSecondYear = ({ 
    ...
    const {
      ...
      defaultValues: {
        ...
        courses: studentData?.courses?.length > 0 
          ? studentData.courses 
          : [{
              courseName: '',
              totalTheory: 0,
            ...
            {fields.map((field, index) => (
              <Paper key={field.id} sx={{ p: 2, mb: 2 }}>
                ...
                <Box display="grid" gridTemplateColumns="repeat(2, 1fr)" gap={2}>
                  ...
                  />
                  <TextField
                    {...register(`courses.${index}.totalTheory`, { valueAsNumber: true })}
                    label="Total Theory"
                    type="number"
                  ...
                  />
                  <TextField
                    {...register(`courses.${index}.totalPractical`, { valueAsNumber: true })}
                  ...
                  />
                  <TextField
                    {...register(`courses.${index}.obtainedTheory`, { valueAsNumber: true })}
                  ...
                  />
                  <TextField
                    {...register(`courses.${index}.obtainedPractical`, { valueAsNumber: true })}
                    label="Obtained Practical"
                    type="number"
                    error={!!errors.courses?.[index]?.obtainedPractical}
                    helperText={errors.courses?.[index]?.obtainedPractical?.message}
                    fullWidth
                    margin="normal"
                  />
                </Box>
